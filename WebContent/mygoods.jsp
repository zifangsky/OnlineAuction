				...
				<table width="479" height="287" style="height: 287px;">
					<tr>
						...
						<td width="97%"><script>
								...
								<s:iterator id="goods" value="#request.mygoodslist">
									<tr>
										<td>
											<!-- 显示我的在拍商品信息 -->
											<div class="goods_pic">
												<img src="/OnlineAuction/uploadImages/${goods.goodsPic}"
										...
										<tr valign="top">
											<td>出价记录：<br> <s:iterator id="b"
													...
													<c:if test="${b.bidStatus != 1}">
														<a class="a_button"
															href="/OnlineAuction/bid/doDeal.action?bidId=${b.bidId}">
															<font color="red">成交</font>
														</a>
													</c:if>
													<br />
												</s:iterator>
							...
							</table> <c:if test="${empty requestScope.mygoodslist }">
  			您目前没有拍卖商品！
  		</c:if></td>
					</tr>
					<tr>
